...
export interface ApiBatchBatch extends Schema.CollectionType {
  ...
  attributes: {
    ...
    batch_no: Attribute.Integer & Attribute.Required & Attribute.Unique;
    received_on: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProductItemProductItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product: Attribute.Relation<
      ...
      'api::product.product'
    >;
    variation_option: Attribute.Relation<
      'api::product-item.product-item',
      'oneToOne',
